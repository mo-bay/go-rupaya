...
if [[ ! -z $NETWORK_ID ]]; then
  case $NETWORK_ID in
    ...
    89 )
      ...
      params="$params --geth-testnet --gcmode archive --http.api db,eth,net,web3,debug,posv"
      ;;
    90 )
...
if [[ ! -z $DEBUG_MODE ]]; then
  params="$params --gcmode archive --http.api db,eth,net,web3,debug,posv"
fi
